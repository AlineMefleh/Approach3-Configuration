...
#writer = pd.ExcelWriter('C:\\Users\\User\\Desktop\\B-Yond\\New_paper-Alarms\\Approach3-Sample2\\Results.xlsx')
...
#number_of_alarms.to_excel(writer, sheet_name='Number of alarms')
